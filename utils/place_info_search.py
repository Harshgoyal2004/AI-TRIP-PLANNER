...
class GooglePlaceSearchTool:
    ...
    def google_search_attractions(self, place: str) -> dict:
        ...
        """
        logger.info(f"🔥 TOOL TRIGGERED: google_search_attractions({place})")
    ...
    def google_search_activity(self, place: str) -> dict:
        ...
        """
        logger.info(f"🔥 TOOL TRIGGERED: search_activity({place})")
...
class TavilyPlaceSearchTool:
    ...
    def tavily_search_attractions(self, place: str) -> dict:
        ...
        """
        logger.info(f"🔥 TOOL TRIGGERED: tavily_search_attractions({place})")
    ...
    def tavily_search_restaurants(self, place: str) -> dict:
        ...
        """
        logger.info(f"🔥 TOOL TRIGGERED: tavily_search_restaurants({place})")
        tavily_tool = TavilySearch(topic="general", include_answer="advanced")
    ...
    def tavily_search_activity(self, place: str) -> dict:
        ...
        """
        logger.info(f"🔥 TOOL TRIGGERED: tavily_search_activity({place})")
        tavily_tool = TavilySearch(topic="general", include_answer="advanced")
    ...
    def tavily_search_transportation(self, place: str) -> dict:
        ...
        """
        logger.info(f"🔥 TOOL TRIGGERED: tavily_search_transportation({place})")
        tavily_tool = TavilySearch(topic="general", include_answer="advanced")
